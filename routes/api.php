...
Route::prefix('1')->group(function () {
    ...
    Route::middleware(['auth:sanctum'])->prefix('teacher')->group(function () {
        ...
        Route::group(['prefix' => 'competitions'], function () {
            Route::get('{sid}', [CompetitionController::class, 'index']);
            Route::post('create', [CompetitionController::class, 'create']);
...
Route::prefix('1')->group(function () {
    ...
    Route::post('organizer/login', [LoginController::class, 'organizerlogin']);
    Route::post('organizer/logout', [LoginController::class, 'organizerlogout']);

    Route::middleware(['auth:organizer'])->prefix('organizer')->group(function () {
        // Schools
        Route::get('/schools/{cid}', [SchoolController::class, 'index']);
        ...
        Route::group(['prefix' => 'competition'], function () {
            ...
            Route::get('{sid}', [CompetitionController::class, 'show']);
