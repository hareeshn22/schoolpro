        ...
        <div class="row">
            ...
            <!-- <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Principals</li>
                    <li class="breadcrumb-item active">Principals List</li>
                </ol>
            </div> -->
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="display table table-centered datatable dt-responsive nowrap" id="principal">
                            <thead>
                                <tr>
                                <tr>
...
$(document).ready(function() {
    ...
    var oTable = $('#principal').DataTable({
        ...
        ajax: {
            url: "{{ route('admin.principals.prfilter') }}",
            type: "POST",
            data: function(d) {
