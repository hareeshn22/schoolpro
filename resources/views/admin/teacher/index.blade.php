            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="display table table-centered datatable dt-responsive nowrap" id="teacher">
                            <thead>
                                <tr>
                                <tr>
...
$(document).ready(function() {
    ...
    var oTable = $('#teacher').DataTable({
        ...
        ajax: {
            url: "{{ route('admin.teachers.filter') }}",
            type: "POST",
            data: function(d) {
...
function deleteFunc(id) {
    if (confirm("Delete teacher?") == true) {
        var id = id;
        // ajax
        $.ajax({
            type: "GET",
